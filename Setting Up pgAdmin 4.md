...
When pgAdmin asks for the password, you need to configure the connection properly:

### 1. Create a New Server in pgAdmin 4

**General Tab:**
- Name: `afritoken` (or whatever you want to call it)

**Connection Tab:**
- **Host name/address:** `localhost` (NOT 18.196.138.205 - that's a remote server)
- **Port:** `5432`
- **Maintenance database:** `postgres`
- **Username:** `afritoken_user`
- **Password:** `7787`
...
After setting it up, you should see:
- **Databases** folder
- Your `afritoken` database
- Tables created by your application

## If You Still Get Password Errors

Try connecting as the default postgres user first:

**Connection Tab:**
- Host: `localhost`
- Port: `5432`
- Username: `postgres` (or your macOS username)
- Password: (leave blank or try your macOS password)

Then you can navigate to the `afritoken` database from there.

**Are you trying to connect to a local database or that remote server at 18.196.138.205?** If you need the remote one, you'll need different credentials.
