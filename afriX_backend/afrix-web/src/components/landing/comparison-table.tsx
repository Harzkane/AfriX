...
export default function ComparisonTable() {
  return (
    <section id="comparison" className="py-24 relative overflow-hidden bg-slate-950/60">
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-slate-800 bg-slate-950/80">
                  <th className="py-5 px-6 text-sm font-semibold text-slate-300 w-1/3">
                    Feature & Capabilities
                  </th>
                  <th className="py-5 px-6 text-sm font-bold text-emerald-400 bg-emerald-500/10 border-x border-emerald-500/20 w-1/4">
                    <div className="flex items-center gap-2">
                      <Sparkles size={16} className="text-emerald-400" />
                      <span>AfriX Rails</span>
                    </div>
                  </th>
                  <th className="py-5 px-6 text-sm font-medium text-slate-400 w-1/5">
                    Traditional Banks
                  </th>
                  <th className="py-5 px-6 text-sm font-medium text-slate-400 w-1/5">
                    Legacy Remittance
              ...
              <tbody className="divide-y divide-slate-800/60 text-xs sm:text-sm">
                {COMPARISON_DATA.map((row, idx) => (
                  ...
                  >
                    ...
                    <td className="py-4 px-6 font-semibold text-emerald-400 bg-emerald-500/5 border-x border-emerald-500/15">
                      <div className="flex items-center gap-2">
