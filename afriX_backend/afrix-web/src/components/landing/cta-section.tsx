  ...
  return (
    <section className="py-20 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="relative rounded-3xl bg-gradient-to-r from-emerald-950/80 via-slate-900/90 to-teal-950/80 border border-emerald-500/30 p-8 sm:p-12 lg:p-16 overflow-hidden shadow-[0_20px_80px_rgba(16,185,129,0.15)] text-center">
          ...
          <p className="text-slate-300 text-base sm:text-lg max-w-2xl mx-auto mt-4 mb-8 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-4 rounded-xl border border-slate-700 hover:border-slate-500 bg-slate-900/80 hover:bg-slate-800 text-white font-semibold text-sm transition-colors"
            >
          ...
          {/* Proof checkmarks */}
          <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-10 mt-10 text-xs font-mono text-slate-400 pt-8 border-t border-slate-800/80">
