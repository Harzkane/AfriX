...
export default function LandingHero() {
  return (
    <section className="relative pt-28 pb-16 sm:pt-36 md:pt-40 sm:pb-24 md:pb-28 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 xl:col-span-6 space-y-6 sm:space-y-8 text-left">
            ...
            {/* Trust Proof Points */}
            <div className="pt-4 border-t border-slate-800/80 grid grid-cols-3 gap-2 sm:gap-4">
              <div>
                <div className="text-lg sm:text-2xl font-bold font-mono text-white">
                  &lt; 60<span className="text-emerald-400">s</span>
                </div>
                <div className="text-[10px] sm:text-xs text-slate-400 mt-0.5">Average Settlement</div>
              </div>
              <div>
                <div className="text-lg sm:text-2xl font-bold font-mono text-white">
                  0.5<span className="text-emerald-400">%</span>
                </div>
                <div className="text-[10px] sm:text-xs text-slate-400 mt-0.5">Low Flat P2P Fee</div>
              </div>
              <div>
                <div className="text-lg sm:text-2xl font-bold font-mono text-white">
                  100<span className="text-emerald-400">%</span>
                </div>
                <div className="text-[10px] sm:text-xs text-slate-400 mt-0.5">Non-Custodial Escrow</div>
              </div>
            </div>
          </div>
