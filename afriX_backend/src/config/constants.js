...
const NOTIFICATION_EVENT_TYPES = {
  ...
  TRANSFER_RECEIVED: "TRANSFER_RECEIVED",   // incoming peer-to-peer transfer
  SWAP_COMPLETED: "SWAP_COMPLETED",         // token swap completed
  // Agent-facing
  ...
  KYC_APPROVED: "KYC_APPROVED",             // agent KYC approved by admin
  KYC_REJECTED: "KYC_REJECTED",             // agent KYC rejected by admin
  // Security
  SECURITY_LOGIN: "SECURITY_LOGIN",
  SECURITY_PASSWORD: "SECURITY_PASSWORD",
  SECURITY_2FA_CHANGED: "SECURITY_2FA_CHANGED", // 2FA enabled or disabled
...
const NOTIFICATION_CATEGORY = {
  transactions: [
    ...
    NOTIFICATION_EVENT_TYPES.DISPUTE_RESOLVED,
    NOTIFICATION_EVENT_TYPES.MINT_REJECTED,
    NOTIFICATION_EVENT_TYPES.BURN_REJECTED,
    NOTIFICATION_EVENT_TYPES.BURN_CONFIRMED,
    NOTIFICATION_EVENT_TYPES.TRANSFER_RECEIVED,
    NOTIFICATION_EVENT_TYPES.SWAP_COMPLETED,
  ],
  requests: [
  ...
  agent_updates: [
    ...
    NOTIFICATION_EVENT_TYPES.KYC_APPROVED,
    NOTIFICATION_EVENT_TYPES.KYC_REJECTED,
  ],
  security: [
    NOTIFICATION_EVENT_TYPES.SECURITY_LOGIN,
    NOTIFICATION_EVENT_TYPES.SECURITY_PASSWORD,
    NOTIFICATION_EVENT_TYPES.SECURITY_2FA_CHANGED,
  ],
